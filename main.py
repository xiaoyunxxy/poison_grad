...
def main(args):
    ...
    if args.poison_type == 'C':
        ...
        data_set = CIFAR10Poisoned(args.poison_data_path, args.constraint, args.poison_type, args.pr, transform=transform_train)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--poison_type', default='C', choices=['C', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6'])
